  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-gray-100 p-4 rounded shadow space-y-4">
        <div>
          <label className="block font-semibold mb-1">Tournament Image</label>
        ...
        <div>
          <label className="block font-semibold mb-1">Room ID</label>
          <input type="text" name="roomId" value={form.roomId} onChange={handleChange} required className="input" />
        </div>
        <div>
          <label className="block font-semibold mb-1">Room Password</label>
          <input type="text" name="roomPassword" value={form.roomPassword} onChange={handleChange} required className="input" />
        </div>
